...
#--- Last Change: 20221117 4PM --- test: changed linear to normal pdf function --- changed back - double check
#--- Last Change: 20221117 10PM --- changed: recentering and rescaling of X.matrix
#---------------------------------- added: The New Formulation for ATET
  ...
  # random.seed.RandomParts = 123456)
{
  ...
  #   for(t in 1:T.total)
  #   {
  #     Y.N.matrix_[j,t] = delta.N.vector_[t] + dnorm(theta.ob.N.matrix_[,t] %*% Z.ob.covariates.matrix_[,j], mean = (5*r.ob.covariates.dim/2), sd = (r.ob.covariates.dim*2.20479)) + dnorm(lambda.unob.N.matrix_[,t] %*% mu.unob.covariates.matrix_[,j], mean = (5*F.unob.covariates.dim/2), sd = (F.unob.covariates.dim*2.20479)) + epsilon.N.matrix_[j,t]
  #   }
  # }
  # 
  # for(j in 1:N.Regions)
  ...
  #   for(t in 1:T.total)
  #   {
  #     Y.I.matrix_[j,t] = upsilon.I.vector_[t] + dnorm(gamma.ob.I.matrix_[,t] %*% Z.ob.covariates.matrix_[,j], mean = (5*r.ob.covariates.dim/2), sd = (r.ob.covariates.dim*2.20479)) + dnorm(eta.unob.I.matrix_[,t] %*% mu.unob.covariates.matrix_[,j], mean = (5*F.unob.covariates.dim/2), sd = (F.unob.covariates.dim*2.20479)) + xi.I.matrix_[j,t]
  #   }
  # }
...
print_model.primitives <- function(model.primitives_, random.seed_)
{
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_mu.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_theta.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_gamma.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_lambda.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_eta.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_epsilon.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_xi.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_YN.txt"))
  ...
  my.file.name = as.character(paste0("output11/ ", Sys.Date(), "ModelPrimitives_YI.txt"))
...
my.file.name = as.character(paste0("output11/ ", Sys.Date(), "SyntheticExperiment.txt"))
...
my.file.name.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_ATE.txt"))
...
my.file.name.null.hypothesis.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_ATE_null_hypothesis.txt"))
...
my.file.name.ATET.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_ATET.txt"))
...
my.file.name.ATEC.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_ATEC.txt"))
...
my.file.name.TreatmentWeights.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_TreatmentWeights.txt"))
...
my.file.name.ControlWeights.copy = as.character(paste0("output11/ ", repetition.RANDOM.SEED, "Different_Optimization_Methods_ControlWeights.txt"))
