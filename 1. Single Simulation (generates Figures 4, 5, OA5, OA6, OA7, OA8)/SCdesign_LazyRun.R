...
#===== Change "input.variance = 1" in Line 7     =====#
#=====================================================#

input.variance = 1 #ChangeThis
...
plot.l.lim = min(T.fitted.N.before - C.fitted.N.before, T.I.after - C.N.after, lower.CI.Cardinality.vector)
plot.u.lim = max(T.fitted.N.before - C.fitted.N.before, T.I.after - C.N.after, upper.CI.Cardinality.vector)+3
