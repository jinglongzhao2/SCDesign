#===========================================================================#
#========== This is a lazy run to generate all simulation results ==========#
...
Synthetic_Experiment_Weakly_Targeted <- function(T.prime_, r.ob.covariates.dim_, N.Regions_, Y.N.matrix, Z.ob.covariates.matrix, beta.vector_, xi_ = 1, digits_ = Weight.digits)
{
  ...
  # }
  # #Off-diagonal elements
  #Diagonal blocks - coming from (beta average vs. treatment weights average)
  for(q.pointer1 in 1:N.dim)
  {
    for(q.pointer2 in 1:N.dim)
    {
  ...
  #===Linear terms
  #Note there are coefficients "2"!
  #The beta averaged part only comes with w weights. The (w and v) weights part are quadratic terms
  C.obj = rep(NA, 2 * N.dim)
  for(c.pointer in 1:N.dim)
  {
    sum.temp = 0
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_ATE.txt"))
...
my.file.name.null.hypothesis.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_ATE_null_hypothesis.txt"))
...
my.file.name.ATET.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_ATET.txt"))
...
my.file.name.ATEC.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_ATEC.txt"))
...
my.file.name.TreatmentWeights.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_TreatmentWeights.txt"))
...
my.file.name.ControlWeights.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "Different_Formulations_ControlWeights.txt"))
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "RandomAssignment_RADiM.txt"))
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "StratifiedAssignment_StADiM.txt"))
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "RandomAssignment_RARegAdj.txt"))
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "RandomAssignment_RA1NN.txt"))
...
my.file.name.copy = as.character(paste0("output/ ", repetition.RANDOM.SEED, "RandomAssignment_RA5NN.txt"))
