...
#--- Last Change: 20250909 3PM --- combined the codes with those analyzing randomization results
#--- Last Change: 20250823 4PM --- added the number of treated units
...
list_of_files_ATE = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_ATE.txt$", full.names = TRUE)
...
list_of_files_ATE_null_hypothesis = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_ATE_null_hypothesis.txt$", full.names = TRUE)
...
list_of_files_ATEC = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_ATEC.txt$", full.names = TRUE)
...
list_of_files_ATET = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_ATET.txt$", full.names = TRUE)
...
list_of_files_TreatmentWeights = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_TreatmentWeights.txt$", full.names = TRUE)
...
list_of_files_ControlWeights = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_ControlWeights.txt$", full.names = TRUE)
...
list_of_files_RADiM = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_RADiM.txt$", full.names = TRUE)
...
list_of_files_StADiM = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_StADiM.txt$", full.names = TRUE)
...
list_of_files_RARegAdj = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_RARegAdj.txt$", full.names = TRUE)
...
list_of_files_RA1NN = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_RA1NN.txt$", full.names = TRUE)
...
list_of_files_RA5NN = list.files(path = "./output_nonlinear/", recursive = TRUE, pattern = "\\_RA5NN.txt$", full.names = TRUE)
...
list_of_files_ATE_Trimmed = sapply(list_of_files_ATE_NoSpaces, substring, 21)
...
my.file.name = as.character(paste0(Sys.Date(), "Nonlinear_Average_Different_Optimization_Methods_ATE.txt"))
write.table(average_outputs_ATE_with_Num, file = my.file.name, append = FALSE, sep = "\t", col.names=FALSE)

# my.file.name = as.character(paste0(Sys.Date(), "Nonlinear_Average_Different_Optimization_Methods_ATE_null_hypothesis.txt"))
# write.table(average_outputs_ATE_null_hypothesis_with_Num, file = my.file.name, append = FALSE, sep = "\t", col.names=FALSE)
# 
# my.file.name = as.character(paste0(Sys.Date(), "Nonlinear_Average_Different_Optimization_Methods_ATEC.txt"))
# write.table(average_outputs_ATEC_with_Num, file = my.file.name, append = FALSE, sep = "\t", col.names=FALSE)

my.file.name = as.character(paste0(Sys.Date(), "Nonlinear_Average_Different_Optimization_Methods_ATET.txt"))
...
my.file.name = as.character(paste0(Sys.Date(), "Nonlinear_Compare_With_Randomization.txt"))
